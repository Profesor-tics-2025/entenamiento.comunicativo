        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {mode === 'register' && (
            <div>
              ...
              <input
                type="text" className="input-dark" placeholder="Tu nombre"
                value={form.name}
          ...
          <div>
            ...
            <input
              type="email" className="input-dark" placeholder="tu@email.com"
              value={form.email}
          ...
          <div>
            ...
            <input
              type="password" className="input-dark" placeholder="••••••••"
              value={form.password}
              onChange={e => setForm({ ...form, password: e.target.value })}
              data-testid="auth-password-input" required
            />
          </div>
      ...
      <div className="relative overflow-hidden">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-5 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            <button onClick={() => setAuthMode('login')} data-testid="login-cta-btn"
              className="text-[#94A3B8] hover:text-[#F1F5F9] text-sm transition-colors">
              Iniciar sesión
            </button>
            <button onClick={() => setAuthMode('register')} data-testid="register-cta-btn"
        ...
        <div className="relative z-10 text-center px-6 pt-16 pb-32 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => setAuthMode('register')} data-testid="hero-register-btn"
            ...
            <button onClick={() => setAuthMode('login')} data-testid="hero-login-btn"
